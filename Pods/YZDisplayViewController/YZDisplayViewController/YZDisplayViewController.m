...
//        CGFloat statusH = [UIApplication sharedApplication].statusBarFrame.size.height;
        ...
        CGFloat kHeight_StatusBar = (kscreen_Height == 812.0)?44.0f: 20.0f;
        CGFloat kHeight_NavBar = (kscreen_Height == 812.0)?88.0f: 64.0f;
        CGFloat titleY = self.navigationController.navigationBarHidden == YES ? kHeight_NavBar : kHeight_StatusBar;
